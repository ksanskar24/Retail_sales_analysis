...
-- How many uniuque customer we have?
 ...
 -- Q.1. Write a SQL query to retrieve all columnsfor sales made on '2022-11-05'

 select* 
 from retail_sales
 where sale_date = '2022-11-05'

-- Q.2. Write a SQL query to retrieve all transactions where the category is 'clothing' and quantity
...
-- Q.4. Write a SQL query to the average age of customers who purchased items from the 'Beauty' category
